...
const Inspector_Transform = () => {
    ...
    const data = useSnapshot(window.ApiServer.state.services.transform.data);
    ...
    return (
        <Inspector.Body>
            ...
            <Inspector.Content>
                <Inspector.SubHeader>General</Inspector.SubHeader>
                <ServiceButton
                    status={status}
                ...
                <InputSelect
                    ...
                    value={data.backend}
                    options={[
                        { label: "LLM Engine", value: Transform_Backends.openai },
